...
class MenuBar(tk.Menu):
    ...
    def show(self):
        ...
        if platform.system() != "Linux":
            ...
            filemenu.add_cascade(label = '数据导出',menu = dataformatmenu)
            dataformatmenu.add_command(label="导出温度数据...", command=self.tempdataToExcel)
            dataformatmenu.add_command(label="导出坐标数据...", command=self.identifydataToExcel)
