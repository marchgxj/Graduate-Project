...
const digioConfig pinLed1   = {2, 5, BIT5, HAL_DIGIO_OUTPUT, 0};
const digioConfig pinLed2   = {2, 6, BIT6, HAL_DIGIO_OUTPUT, 0};
const digioConfig pinLed3   = {2, 7, BIT7, HAL_DIGIO_OUTPUT, 0};
const digioConfig pinLed4   = {3, 0, BIT0, HAL_DIGIO_OUTPUT, 0};
...
const digioConfig SWITCH1   = {2, 1, BIT1, HAL_DIGIO_OUTPUT, 0};
const digioConfig SWITCH2   = {2, 2, BIT2, HAL_DIGIO_OUTPUT, 0};
const digioConfig SWITCH3   = {2, 3, BIT3, HAL_DIGIO_OUTPUT, 0};
...
void GPIO_Init()
{
    ...
    halDigioConfig(&SWITCH1);
    halDigioConfig(&SWITCH2);
    halDigioConfig(&SWITCH3);
