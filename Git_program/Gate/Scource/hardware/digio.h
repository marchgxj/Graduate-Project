...
#define SWITCH1_LOW   (P2OUT &= ~ BIT1)
#define SWITCH1_HIGH  (P2OUT |= BIT1)
#define SWITCH2_LOW   (P2OUT &= ~ BIT2)
#define SWITCH2_HIGH  (P2OUT |= BIT2)
#define SWITCH3_LOW   (P2OUT &= ~ BIT3)
#define SWITCH3_HIGH  (P2OUT |= BIT3)
