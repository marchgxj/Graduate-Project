...
//----------------------------------------------------------------------------------
#define HAL_LED_SET_1   (P2OUT &= ~ BIT5)//¡¡
#define HAL_LED_SET_2   (P2OUT &= ~ BIT6)
#define HAL_LED_SET_3   (P2OUT &= ~ BIT7)
#define HAL_LED_SET_4   (P3OUT &= ~ BIT0)
#define HAL_PLU_SET     (P6OUT |= BIT5)
      
#define HAL_LED_CLR_1   (P2OUT |= BIT5)
#define HAL_LED_CLR_2   (P2OUT |= BIT6)
#define HAL_LED_CLR_3   (P2OUT |= BIT7)
#define HAL_LED_CLR_4   (P3OUT |= BIT0)
#define HAL_PLU_CLR     (P6OUT &= ~ BIT5)

#define HAL_LED_TGL_1   (P2OUT ^= BIT5)
#define HAL_LED_TGL_2   (P2OUT ^= BIT6)
#define HAL_LED_TGL_3   (P2OUT ^= BIT7)
#define HAL_LED_TGL_4   (P3OUT ^= BIT0)
