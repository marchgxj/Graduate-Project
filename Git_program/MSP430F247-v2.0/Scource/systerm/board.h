...
//----------------------------------------------------------------------------------
#define HAL_LED_SET_1   (P5OUT &= ~ BIT1)//¡¡
#define HAL_LED_SET_2   (P5OUT &= ~ BIT2)
#define HAL_LED_SET_3   (P5OUT &= ~ BIT3)
#define HAL_LED_SET_4   (P5OUT &= ~ BIT4)
#define HAL_PLU_SET     (P6OUT |= BIT5)
      
#define HAL_LED_CLR_1   (P5OUT |= BIT1)
#define HAL_LED_CLR_2   (P5OUT |= BIT2)
#define HAL_LED_CLR_3   (P5OUT |= BIT3)
#define HAL_LED_CLR_4   (P5OUT |= BIT4)
#define HAL_PLU_CLR     (P6OUT &= ~ BIT5)

#define HAL_LED_TGL_1   (P5OUT ^= BIT1)
#define HAL_LED_TGL_2   (P5OUT ^= BIT2)
#define HAL_LED_TGL_3   (P5OUT ^= BIT3)
#define HAL_LED_TGL_4   (P5OUT ^= BIT4)
#define HAL_PLU_TGL     (P6OUT ^= BIT5)
