...
const digioConfig pni_mosi_out   = {3, 3, BIT3, HAL_DIGIO_OUTPUT, 0};
const digioConfig pni_miso_in   = {3, 2, BIT2, HAL_DIGIO_INPUT, 0};
const digioConfig pni_sck_out   = {3, 1, BIT1, HAL_DIGIO_OUTPUT, 0};
const digioConfig pni_scs_out   = {3, 4, BIT4, HAL_DIGIO_OUTPUT, 1};
const digioConfig pni_drdy_in   = {3, 0, BIT0, HAL_DIGIO_INPUT, 0};
...
{      
  ...
  *Zn = (uint16)sensor;
  ...
  MagneticUnit.ZValue_HP = (uint16)sensor_b;
